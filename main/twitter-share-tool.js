...
function showTooltip(selection, shareButtonContainer) {
	...
	if (clientRects.length < 2) {
		xPosition = Math.round(firstLine.left) + Math.round(firstLine.width / 2);
	} else {
	...
	if (yPosition < 60) {
		shareButtonContainer.style.top = yPosition + 'px';
	} else {
		shareButtonContainer.style.top = yPosition - 50 + 'px';
	}
	shareButtonContainer.style.left = xPosition - 30 + 'px';
